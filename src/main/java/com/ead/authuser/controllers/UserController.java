...
public class UserController {
    ...
    public ResponseEntity<Object> updatePassword(@PathVariable(value = "userId") UUID id,
    ...
    public ResponseEntity<Object> updateImage(@PathVariable(value = "userId") UUID id,
